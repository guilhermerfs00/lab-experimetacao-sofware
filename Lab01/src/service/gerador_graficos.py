...
class GeradorGraficos:
    ...
    def _rq01_idade(self, dataframe_repositorios):
        figura, eixo = plt.subplots(figsize=(10, 5))
        eixo.hist(dataframe_repositorios["Idade (anos)"], bins=20, color="steelblue", edgecolor="white")
        ...
        mediana_idade = dataframe_repositorios["Idade (anos)"].median()
    ...
    def _rq02_pull_requests(self, dataframe_repositorios):
        figura, eixo = plt.subplots(figsize=(10, 5))
        eixo.hist(dataframe_repositorios["Pull Requests Aceitos"], bins=30, color="darkorange", edgecolor="white")
        eixo.set_title("RQ02 – Distribuição de Pull Requests Aceitas")
        eixo.set_xlabel("Total de PRs Aceitas")
        eixo.set_ylabel("Número de Repositórios")
        eixo.set_yscale("log")
        mediana_prs = dataframe_repositorios["Pull Requests Aceitos"].median()
    ...
    def _rq03_releases(self, dataframe_repositorios):
        figura, eixo = plt.subplots(figsize=(10, 5))
        eixo.hist(dataframe_repositorios["Releases"], bins=30, color="seagreen", edgecolor="white")
        eixo.set_title("RQ03 – Distribuição do Total de Releases")
        eixo.set_xlabel("Total de Releases")
        eixo.set_ylabel("Número de Repositórios")
        eixo.set_yscale("log")
        mediana_releases = dataframe_repositorios["Releases"].median()
    ...
    def _rq04_atualizacao(self, dataframe_repositorios):
        figura, eixo = plt.subplots(figsize=(10, 5))
        eixo.hist(dataframe_repositorios["Dias Desde Atualização"], bins=30, color="mediumpurple", edgecolor="white")
        eixo.set_title("RQ04 – Dias Desde a Última Atualização")
        eixo.set_xlabel("Dias")
        eixo.set_ylabel("Número de Repositórios")
        mediana_dias = dataframe_repositorios["Dias Desde Atualização"].median()
    ...
    def _rq05_linguagens(self, dataframe_repositorios):
        top_linguagens = dataframe_repositorios["Linguagem Principal"].value_counts().head(15)
    ...
    def _rq06_issues_fechadas(self, dataframe_repositorios):
        figura, eixo = plt.subplots(figsize=(10, 5))
        eixo.hist(dataframe_repositorios["Razão Issues Fechadas"], bins=20, color="tomato", edgecolor="white")
        eixo.set_title("RQ06 – Distribuição da Razão de Issues Fechadas")
        eixo.set_xlabel("Proporção de Issues Fechadas (0 a 1)")
        eixo.set_ylabel("Número de Repositórios")
        mediana_proporcao = dataframe_repositorios["Razão Issues Fechadas"].median()
